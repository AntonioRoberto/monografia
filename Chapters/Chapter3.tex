...
\end{theorem}
\textbf{Demonstração:}
A demonstração a seguir foi retirada livro: \textit{OLIVEIRA SANTOS, José Plínio de. Introdução à Teoria dos Números. IMPA, 1998. 72 p.}
...
Portanto temos $\Phi(m)$ linhas onde todos os elementos são primos com $m$.

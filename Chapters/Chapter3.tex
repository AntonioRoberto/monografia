...
\textbf{Análise:}
Se precalcular $\Phi[]$ teremos que o fator limitando do algoritmo será o laço da linha $5$, e a complexidade do algoritmo será $O(\frac{N}{D})$.

...
Nessa seção vamos descrever algumas definições e propriedades que serão utilizadas ao longo desse trabalho.
...
\textbf{Análise:}
Primeiro provaremos a corretude do algoritmo fazendo umia indução sobre o número de chamadas recursivas $N$.
...
Já o laço mais interno na linha $9$ itera sobre todos os múltiplas de $p$ de $p^2$ até $N$, e assim consome tempo
$O(N/p)$. 
